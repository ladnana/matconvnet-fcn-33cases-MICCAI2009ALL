...
imdb.paths.image = esc(fullfile(opts.dataDir, 'Crop_CentroidIamgesbl3_128', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'Crop_CentroidIamgesbl3_128', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'Crop_CentroidSegmentationClassbl3_128', '%s.png')) ;
