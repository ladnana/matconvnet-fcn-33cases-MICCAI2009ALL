...
imdb.paths.image = esc(fullfile(opts.dataDir, 'CropDCMImages_double', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'CropDCMImages_double', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'CropSegmentationClass_double', '%s.png')) ;
