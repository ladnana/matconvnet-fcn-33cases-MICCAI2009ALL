...
imdb.paths.image = esc(fullfile(opts.dataDir, 'CropDCMImages_33case', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'CropDCMImages_33case', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'CropSegmentationClass_33case', '%s.png')) ;
