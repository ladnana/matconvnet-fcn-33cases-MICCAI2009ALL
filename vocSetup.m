...
imdb.paths.image = esc(fullfile(opts.dataDir, 'CropDCMImages-i-123+132+20+08_scale_Vmirror-control33case', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'CropDCMImages-i-123+132+20+08_scale_Vmirror-control33case', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'CropSegmentationClass-i-123+132+20+08_Scale_Vmirror-control33case', '%s.png')) ;
