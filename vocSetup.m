...
imdb.paths.image = esc(fullfile(opts.dataDir, 'CropDCMImages-shape', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'CropDCMImages-shape', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'CropSegmentationClass-shape', '%s.png')) ;
