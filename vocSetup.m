...
imdb.paths.image = esc(fullfile(opts.dataDir, 'CropDCMImages-123+08', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'CropDCMImages-123+08', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'CropSegmentationClass-123+08', '%s.png')) ;
