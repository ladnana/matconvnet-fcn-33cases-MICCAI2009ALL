...
imdb.paths.image = esc(fullfile(opts.dataDir, 'CropDCMImagesMirror', '%s.dcm')) ;
imdb.paths.image2 = esc(fullfile(opts.dataDir, 'CropDCMImagesMirror', '%s.mat')) ;
...
if opts.includeSegmentation
  ...
  imdb.paths.classSegmentation = esc(fullfile(opts.dataDir, 'CropSegmentationClassMirror', '%s.png')) ;
