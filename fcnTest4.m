...
opts.expDir = 'data/fcn4s-500-33cases_128' ;%edited by mR
opts.dataDir = 'data/33cases_MICCAI2009' ;
opts.modelPath = 'data/fcn4s-500-33cases_128/net-epoch-500.mat' ;%edited by mR
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('data/fcn4s-500-33cases_128', 'info.txt')); 
