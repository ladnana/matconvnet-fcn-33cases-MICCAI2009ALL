...
opts.expDir = 'H:/nana/data/fcn4s-100-33cases_MICCAI2009_128_rate(1-0.8-0.5)' ;%edited by mR
opts.dataDir = 'H:/nana/data/33cases_MICCAI2009' ;
opts.modelPath = 'H:/nana/data/fcn4s-100-33cases_MICCAI2009_128_rate(1-0.8-0.5)/net-epoch-100.mat' ;%edited by mR
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('H:/nana/data/fcn4s-100-33cases_MICCAI2009_128_rate(1-0.8-0.5)', 'info.txt')); 
