...
opts.expDir = 'H:/nana/data/fcn4s-500-33cases_MICCAI2009-123+132-i_20-1_2lr_4scaleLoss+2upshape+2.0-1.5-1_3dshape+2mshape-Vmirror_0mean1' ;%edited by mR
opts.dataDir = 'H:/nana/data/33cases_MICCAI2009' ;
opts.modelPath = 'H:/nana/data/fcn4s-500-33cases_MICCAI2009-123+132-i_20-1_2lr_4scaleLoss+2upshape+2.0-1.5-1_3dshape+2mshape-Vmirror_0mean1/net-epoch-33.mat' ;%edited by mR
...
for i = 1:numel(val)
  ...
  if Temp_num<34
      rgbPath = sprintf(imdb.paths.image2, imdb.images.name{imId}) ;
      rgb = load(rgbPath) ;
      rgb = rgb.picture;
  else
...
%   if mod(i - 1,30) == 0 || i == numel(val)
    ...
    diary(fullfile('H:/nana/data/fcn4s-500-33cases_MICCAI2009-123+132-i_20-1_2lr_4scaleLoss+2upshape+2.0-1.5-1_3dshape+2mshape-Vmirror_0mean1', 'info.txt')); 
